...
import { ChainVaultProgram } from "../target/types/chain_vault_program";

describe("chain-vault-program", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());

  const program = anchor.workspace.chainVaultProgram as Program<ChainVaultProgram>;
